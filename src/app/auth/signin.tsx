...
export default function SignIn() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: "40px auto", padding: 32, border: "1px solid #eee", borderRadius: 16 }}>
      <h2 style={{ fontSize: 28, fontWeight: 700, marginBottom: 24 }}>Sign In</h2>
      {providers?.credentials && (
        ...
        >
          ...
          <button type="submit" style={{ width: "100%", padding: 10, fontSize: 18, background: "#0af", color: "#fff", border: "none", borderRadius: 8 }}>Sign in with Email</button>
        </form>
      )}
      ...
      <hr style={{ margin: "24px 0" }} />
      {/* Mobile OTP login */}
      <a href="/auth/mobile-signin" style={{ display: "block", textAlign: "center", marginTop: 16, color: "#0af", fontWeight: 600 }}>
